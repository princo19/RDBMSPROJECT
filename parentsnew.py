...
class Parent:
    ...
    def add_parents(self):
            ...
            if (L=="" or S=="" or F=="" or M=="" or O=="" or T=="" or W=="" or P=="") :
               messagebox.showerror("Error","All Fields Are Required!!!")
                ...
                con.commit()
                self.fetch_dat()
                messagebox.showinfo("Success","Record has been Added Successfull",parent=self.window)
                self.clear_data()
                con.close()
    ...
    def clear_data(self):
            ...
            if (L=="" or S=="" or F=="" or M=="" or O=="" or T=="" or W=="" or P=="") :
                ...
                messagebox.showinfo("Success","Record Cleared Successfully",parent=self.window)
