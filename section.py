...
class Section:
    ...
    def add_section(self):
        ...
        if (J=="" or T=="" or I=="" or C=="" or Z=="" or K=="") :
             ...
             con.commit()
             self.fetch_d()
             messagebox.showinfo("Success","Record has been Added Successfull",parent=self.window3)
             self.clear_d()
             con.close()
    ...
    def clear_d(self):
            ...
            K=self.Doe_var.get()
            if (J=="" or T=="" or I=="" or C=="" or Z=="" or K=="") :
                  messagebox.showerror("Error","All Fields Are Required!!!",parent=self.window3)
            else:
                  ...
                  self.Doj_var.set('')
                  self.Doe_var.set('')
                  messagebox.showinfo("Success","Record Cleared Successfully",parent=self.window3)
    ...
    def update_d(self):
            ...
            con.commit()
            self.fetch_d()
            messagebox.showinfo("Success","Record Updated Successfully",parent=self.window3)
            self.clear_d()
            con.close()
