...
class Student:
    ...
    def add_students(self):
        if self.Roll_no_var.get()=="" or self.name_var.get()=="" or self.dob_var.get()=="" or self.sex_var.get()=="" or self.add_var.get()=="" or self.state_var.get()=="" or self.email_var.get()=="" or self.mobile_var.get()=="" :
            ...
            self.clear()
            con.close()
            messagebox.showinfo("Success","Record has been Added Successfully",parent=self.root)
    ...
    def clear(self):
         if self.Roll_no_var.get()=="" or self.name_var.get()=="" or self.dob_var.get()=="" or self.sex_var.get()=="" or self.add_var.get()=="" or self.state_var.get()=="" or self.email_var.get()=="" or self.mobile_var.get()=="" :
            ...
            self.email_var.set('')
            self.mobile_var.set('')
            messagebox.showinfo("Success","Record Cleared Successfully",parent =self.root)
