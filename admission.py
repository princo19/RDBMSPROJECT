...
class Admission:
    ...
    def add_admsn(self):
        ...
        if G=='' or S=='' or C=='' or Q=='' or B=='' or X=='':
            ...
            con.commit()
            self.fetch_da()
            messagebox.showinfo("Success","Record has been Added Successfull",parent=self.window2)
            #self.clear_da()
            con.close()
    ...
    def clear_da(self):
            ...
            if (G=='' or S=='' or C=='' or Q=='' or B=='' or X==''):
                ...
                self.Branch_var.set('')
                self.Doa_var.set('')
                messagebox.showinfo("Success","Record Cleared Successfully",parent=self.window2)
    ...
    def update_det(self):
        ...
        con.commit()
        self.fetch_da()
        messagebox.showinfo("Success","Record Updated Successfully",parent=self.window2)
        self.clear_da()
        con.close()
